package com.oracle.sim.pageFactory;
...
public class PageFactory {
	...
	static {
		try {
			...
			getClassInPackage(new com.oracle.core.utils.PropertyReader()
	...
	public SimBasePage initialize(String pageName) {
		SimBasePage page = null;
		...
		try {
			...
			if (packageName != null) {
				String pageClassFullName = packageName + "."
						+ formattedPageName;
				page = (SimBasePage) Class.forName(pageClassFullName)
						.newInstance();
			} else {
