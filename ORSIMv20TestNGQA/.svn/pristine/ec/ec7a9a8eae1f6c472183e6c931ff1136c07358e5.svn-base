...
public class ItemBasketSearchCriteriahHierarchyDepartment {
	...
	public void verifyDepartmentHierarchy(Map<String,String> map) throws Exception {
		...
		String tagName=ItemBasketPage.getAttributeValue("DepartmentDropDownButton",map.get("TagNameAttribute"));
		...
		if(tagName.equals(map.get("TagName"))){
			...
			ItemBasketPage.verifyValuesAreEqual(map.get("DepartmentDefaultValue"),ItemBasketPage.getAttributeValue("DepartmentDropDownButton",map.get("PlaceHolderAttribute")));
			...
			ItemBasketPage.explicitWaitForElementToBeClickable("DepartmentDropDownButton");
			ItemBasketPage.selectDropDownValue("DepartmentDropDownButton",map.get("DepartmentDefaultValue"));

			//Verify the class drop down is disabled or not
