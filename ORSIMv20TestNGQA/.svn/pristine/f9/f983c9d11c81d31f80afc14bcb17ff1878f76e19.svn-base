...
public class StoreAdminDefaultUIAndNavigation {
	...
	public void verifyStoreAdminDefaultUI(Map<String, String> map) throws Exception {
		...
		StoreAdminDefaultPage.click("TopicColumn");
		StoreAdminDefaultPage.implicitWait();
		StoreAdminDefaultPage.columnSorting("TopicColumnValues", "TopicColumn", "ascending");
		...
		StoreAdminDefaultPage.implicitWait();
		StoreAdminDefaultPage.columnSorting("OptionColumnValues", "OptionColumn", "ascending");
		...
		StoreAdminDefaultPage.implicitWait();
		StoreAdminDefaultPage.columnSorting("ValueColumnValues", "ValueColumn", "ascending");
