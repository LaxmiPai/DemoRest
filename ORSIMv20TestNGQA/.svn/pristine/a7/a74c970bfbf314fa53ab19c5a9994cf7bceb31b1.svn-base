...
public class TicketPrintFormatDetailApplyBlock {

	public static Logger logger = Logger.getLogger(TicketPrintFormatDetailApplyBlock.class.getName());
	...
	SimBasePage TicketPage;
			...
			@DataProvider(name = "TicketFoematDetail")
	...
	@Test(dataProvider="TicketFoematDetail", priority=1)
	...
	@Test(dataProvider="TicketFoematDetail", priority=2)
	...
	@Test(dataProvider="TicketFoematDetail", priority=3)
	public void TicketPrintFormatVerifyEdit(Map<String,String> map) throws Exception {
		logger.info("Method Name: TicketPrintFormatVerifyEdit");
		
		//Filter the record created 
		...
		//To verify the edit detail block is enabled
		TicketPage.verifyElementIsEnabled("TicketFormatDetailScreen");
		...
		TicketPage.verifyElementIsEnabled("TicketFormatDetailapplyButton");
		
		//Verify detail block cancel button is present
		TicketPage.verifyElementIsPresent("TicketFormatDetailCancelButton");
		TicketPage.verifyElementIsEnabled("TicketFormatDetailCancelButton");
