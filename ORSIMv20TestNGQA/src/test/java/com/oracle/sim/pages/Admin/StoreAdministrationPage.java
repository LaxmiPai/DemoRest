...
public class StoreAdministrationPage extends SimBasePage{
	public StoreAdministrationPage() throws Exception{
		super();
		//Navigation
		...
		addObject("StoreAdministrationMenu", By.xpath("//span[text()='Store Administration']"));
		addObject("StoreAdministrationDefaultMenu", By.xpath("//span[text()='Store Administration Default']"));
		...
		addObject("RestoreDefaults",By.xpath("//oj-button[@id='reset-button']"));
		...
		addObject("SelectStores",By.xpath("//oj-button[@id='select-stores-button']//div[@class='oj-button-label']")); 
		addObject("SelectedStoreText",By.xpath("//oj-toolbar[@id='sim-screen-stores-toolbar']//parent::span[contains(text(),'Selected Store')]"));
