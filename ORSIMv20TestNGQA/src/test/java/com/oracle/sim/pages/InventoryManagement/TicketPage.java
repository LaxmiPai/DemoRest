...
public class TicketPage extends SimBasePage{
	public TicketPage() throws Exception {
		...
		addObject("FormatTypeDropDown",By.xpath("//oj-select-single[@id='input-format-type']"));
		//addObject("FormatTypeDropDownList",By.xpath("//div[@id='oj-select-choice-input-format']//a"));
		addObject("FormatTypeDropDownList",By.xpath("//oj-select-single[@id='input-format']"));
		...
		addObject("ErrorMessage1",By.xpath("//oj-select-single[@id='input-format-type']//span[@class='oj-message-content']"));
		addObject("ErrorMessage2",By.xpath("//oj-select-single[@id='input-format']//span[@class='oj-message-content']"));
		...
		addObject("FormatTypeTextBox",By.xpath("//span[contains(@id,'format-type_selected')]"));
		addObject("FormatTextBox",By.xpath("//span[contains(@id,'format_selected')]"));
