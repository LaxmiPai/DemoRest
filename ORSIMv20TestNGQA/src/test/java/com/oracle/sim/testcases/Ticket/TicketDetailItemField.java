...
public class TicketDetailItemField {

	public static Logger logger = Logger.getLogger(TicketDetailItemField.class.getName());
	...
	public void ticketDetailItemFieldVerify(Map<String, String> map) throws Exception {
		...
		TicketPage.verifyElementIsEditable("ItemScanBox");
		...
		Thread.sleep(Long.parseLong(propReader.getApplicationproperty("Low")));
		TicketPage.verifyElementIsPresent("SaveButton");
