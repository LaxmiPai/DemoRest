...
public class StoreAdminUIAndNavigation {
	...
	public void verifyStoreAdminUI(Map<String, String> map) throws Exception {
		...
		StoreAdminPage.click("TopicColumn");
		StoreAdminPage.implicitWait();
		StoreAdminPage.columnSorting("TopicColumnValues", "TopicColumn", "ascending");
		...
		StoreAdminPage.implicitWait();
		StoreAdminPage.columnSorting("OptionColumnValues", "OptionColumn", "ascending");
		...
		StoreAdminPage.implicitWait();
		StoreAdminPage.columnSorting("ValueColumnValues", "ValueColumn", "ascending");
...
//		Thread.sleep(Long.parseLong(propReader.getApplicationproperty("Low")));
		...
		StoreAdminPage.enterIntoTextBox("OptionColumnFilter", map.get("OptionFilterStoreDefault"));
		Thread.sleep(Long.parseLong(propReader.getApplicationproperty("Low")));
		StoreAdminPage.verifyTableRowContentsOfColumn("OptionColumnValues", map.get("OptionFilterStoreDefault"));
