...
public class TicketDetailDeleteSecurityPermission {

	public static Logger logger = Logger.getLogger(TicketDetailDeleteSecurityPermission.class.getName());
	...
	public void ticketDeletePermissionVerify(Map<String, String> map) throws Exception {

		logger.info("Method Name:TicketDeletePermissionVerify ");
		...
		TicketPage.verifyElementIsPresent("DeleteButton");
		TicketPage.explicitWaitForElementToBeClickable("ItemIdLink");
		TicketPage.click("ItemIdLink");
		TicketPage.verifyTextValue("TicketDetailScreenTitle", map.get("TicketDetail"));
		Thread.sleep(Long.parseLong(propReader.getApplicationproperty("Low")));
